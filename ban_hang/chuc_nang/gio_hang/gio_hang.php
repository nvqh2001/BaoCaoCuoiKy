		  ...
		  <form action='' method='post' >
			...
			<td class="ring-in t-data">
				<a href="single.html" class="at-in">
					<img src=hinh_anh/san_pham/<?php echo $tv_2['hinh_anh'] ?> class="img-responsive" alt="">
				</a>
			<div class="sed">
			...
			<td class="t-data"><?php echo $tv_2['gia'] ?> đ</td>
			<td class="t-data">
<?php 
	...
	?>
			...
			<td class="t-data t-w3l"><a class=" add-1" href="#"><?php echo $tien ?> đ</a></td>
		  	...
		  	<tr>
		  		...
		  		<td>Tổng thành tiền : <?php echo $tong_cong ?> đ</td>
		 	</tr>
